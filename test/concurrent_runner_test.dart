...
void main() {
  List<ConcurrentAction<int>> actions;
  _TestConcurrentActionsMock testObject;
  ...
  setUpAll(() {
    ...
    actions = List.generate(
        10,
        (index) => () {
              when(testObject.action(index)).thenAnswer((_) => Future.delayed(
                  Duration(milliseconds: index * 100), () => index));
